...
export default function Nav() {
	...
	return (
		<header className="bg-opacity-95 bg-sky-800 dark:bg-gray2 border-b-[1px] dark:border-dark2 w-full fixed top-0 z-10">
						...
						<div className="flex items-center gap-5">
							...
							>
								<svg
									viewBox="0 0 24 24"
									aria-hidden="true"
									className="h-10 w-10 fill-gray-200 hover:fill-gray-100 dark:fill-white dark:hover:fill-gray-400 transition-colors"
								>
									<path
										fillRule="evenodd"
										clipRule="evenodd"
