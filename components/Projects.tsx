...
export default function Projects({
	...
	return (
		<div
		 ...
		 hover:bg-gray-100 dark:bg-gray2 border-gray-200 dark:border-transparent border-[1px] rounded-md
		  dark:hover:border-blue1 hover:border-blue2 hover:bg-opacity-30 shadow-md hover:shadow-sm transition-all"
		>
			<div>
				...
				<p
					className={`text-base font-medium text-gray-700 dark:text-gray-300 mb-4`}
				>
					{description}
				</p>
